    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4 p-2">
            <div class="shadow-sm h-100 bg-white rounded-3 p-3">
                ...
                <div class="row">
                   <div class="col-12">
                       <p class="text-bold text-xs my-1 text-dark"> TOTAL: <i class="bi bi-currency-rupee"></i> <span id="total"></span></p>
                       <p class="text-bold text-xs my-2 text-dark"> PAYABLE: <i class="bi bi-currency-rupee"></i>  <span id="payable"></span></p>
                       <p class="text-bold text-xs my-1 text-dark"> VAT(5%): <i class="bi bi-currency-rupee"></i>  <span id="vat"></span></p>
                       <p class="text-bold text-xs my-1 text-dark"> Discount: <i class="bi bi-currency-rupee"></i>  <span id="discount"></span></p>
